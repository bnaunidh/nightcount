...
import { dressStation, mergeStatics, settleProps } from "./world/props.js";
import { makeSky, dressLandscape } from "./world/landscape.js";
...
async function boot() {
  ...
  msg.textContent = "the road, and what is past it";
  makeSky(scene);
  await dressLandscape(scene, station);
  ...
  const ctx = { game, station, player, ui, audio, scene, camera, renderer, interact, THREE, BUILD };
