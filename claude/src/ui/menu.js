...
import { EDITION, EDITIONS, editionHref } from "../core/edition.js";
...
export class Menus {
  ...
  _rows(tab) {
    ...
    if (tab === "controls") return [
      ...
      { type: "key", key: "sprint", label: "Walk slower" },
  ...
  showDev() {
    ...
    this.paint = () => {
      ...
      // Which build: this one, or the other edition's. Only where both are
